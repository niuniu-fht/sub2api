export default {
    settings: {
      ...
      site: {
        ...
        contactInfo: 'Contact QQ Group',
        contactInfoPlaceholder: 'e.g., 77889900',
        contactInfoHint: 'Enter a QQ group number. It appears in the top navigation and user menu and can be copied.',
